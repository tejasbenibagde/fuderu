...
<FuderuDemo
  title="Module hook behavior"
  description="Toggle dynamic shape, transparency, spread, and pattern compositing to see how module hooks alter points, per-stamp config, and stroke mix-in."
  mode="modules"
/>
