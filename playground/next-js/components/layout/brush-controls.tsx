...
export function BrushControls({
  ...
  return (
    <div className="space-y-6 p-4">
      <div>
        <h2 className="text-sm font-semibold">Brush Controls</h2>
      ...
      <div className="space-y-3">
        ...
        <Slider
          ...
          max={1}
          step={0.01}
          onValueChange={(v) => onFlowChange(v[0])}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider
          ...
          max={5}
          step={0.01}
          onValueChange={(v) => onSpacingChange(v[0])}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider
          ...
          max={1}
          step={0.01}
          onValueChange={(v) => onRoundnessChange(v[0])}
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch checked={smooth} onCheckedChange={onSmoothChange} />
      </div>
