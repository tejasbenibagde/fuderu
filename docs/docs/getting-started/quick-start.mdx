...
5. **[React Integration](/docs/guides/integration-react)** - Learn advanced patterns for React apps
...
Try the [interactive editor](/editor) or revisit the [Layer System](/docs/api/layers) guide for more advanced workflows.
