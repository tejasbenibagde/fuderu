...
Fuderu 1.3.0 expands beyond brush rendering into a complete, production-ready canvas architecture: featuring first-class document persistence, layer-level Alpha Lock and Layer Lock, native scanline flood fill, shape primitives, raster text, and typed state event subscriptions.
